...
namespace Tyuiu.DanilovAS.Sprint2.Task7.V12
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (result = true)
            {
                Console.Write("Точка находится в заштрихованной области.");
            }
            else
            {
                Console.Write("Точка не находится в заштрихованной области.");
            }
